...
(() => BbPromise.resolve().then(() => {
  ...
  const davis = new Davis({
    ...
    logLevel: 'info',
    userPlugins: ['./plugins/perform','./plugins/performFollowup','./plugins/performUpset','./plugins/performSignOff','./plugins/businessBriefing','./plugins/technicalBriefing','./plugins/test'], // uncomment this line to load the davisWeather plugin
  });
